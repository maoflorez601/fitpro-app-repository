    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <form method="POST" action="{{ route('foods.store') }}" class="bg-gray-900 p-6 rounded-lg">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="category" name="category" type="text" class="w-full px-3 py-2 rounded-lg bg-gray-800 text-gray-300 focus:outline-none focus:bg-gray-700">
                    </div>
                
                    <div class="mb-4">
                        <label for="protein" class="block text-gray-300">Proteínas</label>
                        <input id="protein" name="protein" type="number" step="0.1" class="w-full px-3 py-2 rounded-lg bg-gray-800 text-gray-300 focus:outline-none focus:bg-gray-700">
                    </div>
                
                    <div class="mb-4">
                        <label for="carbs" class="block text-gray-300">Carbohidratos</label>
                        <input id="carbs" name="carbs" type="number" step="0.1" class="w-full px-3 py-2 rounded-lg bg-gray-800 text-gray-300 focus:outline-none focus:bg-gray-700">
                    </div>
                
                    <div class="mb-4">
                        <label for="fat" class="block text-gray-300">Grasas</label>
                        <input id="fat" name="fat" type="number" step="0.1" class="w-full px-3 py-2 rounded-lg bg-gray-800 text-gray-300 focus:outline-none focus:bg-gray-700">
                    </div>
